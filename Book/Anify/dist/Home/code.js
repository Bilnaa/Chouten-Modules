...
async function logic(payload) {
    ...
    const data = JSON.parse(await sendRequest("https://api.anify.tv/seasonal?type=manga&fields=[id,description,bannerImage,coverImage,title,genres,format,averageRating,chapters,year,type]", {}));
    ...
    const recents = JSON.parse(await sendRequest("https://api.anify.tv/recent?type=manga", {}));
    const recentData = [];
    for (let i = 0; i < (recents === null || recents === void 0 ? void 0 : recents.length); i++) {
        ...
        recentData.push({
            ...
            buttonText: "",
            indicator: item.year + "",
            current: Number((_t = (_s = (_r = item.chapters) === null || _r === void 0 ? void 0 : _r.latest) === null || _s === void 0 ? void 0 : _s.latestChapter) !== null && _t !== void 0 ? _t : 0),
            total: Number((_u = item.totalChapters) !== null && _u !== void 0 ? _u : 0),
        });
    }
    const trendingData = [];
    for (let i = 0; i < ((_v = data.trending) === null || _v === void 0 ? void 0 : _v.length); i++) {
        ...
        trendingData.push({
            ...
            buttonText: "",
            indicator: item.year + "",
            current: Number((_4 = (_3 = (_2 = item.chapters) === null || _2 === void 0 ? void 0 : _2.latest) === null || _3 === void 0 ? void 0 : _3.latestChapter) !== null && _4 !== void 0 ? _4 : 0),
            total: Number((_5 = item.totalChapters) !== null && _5 !== void 0 ? _5 : 0),
        });
    }
    const topRatedData = [];
    for (let i = 0; i < ((_6 = data.top) === null || _6 === void 0 ? void 0 : _6.length); i++) {
        ...
        topRatedData.push({
            ...
            buttonText: "",
            indicator: item.year + "",
            current: Number((_15 = (_14 = (_13 = item.chapters) === null || _13 === void 0 ? void 0 : _13.latest) === null || _14 === void 0 ? void 0 : _14.latestChapter) !== null && _15 !== void 0 ? _15 : 0),
            total: Number((_16 = item.totalChapters) !== null && _16 !== void 0 ? _16 : 0),
        });
    }
    const result = [
        {
